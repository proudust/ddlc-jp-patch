...
translate None label:
    label ch30_main:
        ...
        scene black
        stop music
        call say_tl("ch30_main_e612037c")
        ...
        play music m1
        call say_tl("ch30_main_db66daac")
        call say_tl("ch30_main_9e85e7db")
        call say_tl("ch30_main_ec2b5f8c")
        call say_tl("ch30_main_a5cba48d")
        call say_tl("ch30_main_f6daf90a")
        call say_tl("ch30_main_e9d294ba")
        ...
        if not list(set(process_list).intersection(stream_list)):
            if currentuser != "" and currentuser.lower() != player.lower():
                ...
                call say_tl("ch30_main_8fe02e7b")
        call say_tl("ch30_main_2e21d70b")
        call say_tl("ch30_main_e02a4cfa")
        call say_tl("ch30_main_89559ba5")
        call say_tl("ch30_main_7772bcfa")
        call say_tl("ch30_main_55ca3dee")
        call say_tl("ch30_main_2fb3db19")
        call say_tl("ch30_main_ca2f4e41")
        call say_tl("ch30_main_a75607c5")
        call say_tl("ch30_main_3fd36ab2")
        call say_tl("ch30_main_14ac7fe0")
        call say_tl("ch30_main_fbf91cb8")
        call say_tl("ch30_main_6cda7bdc")
        call say_tl("ch30_main_820a4399")
        call say_tl("ch30_main_53d84e58")
        call say_tl("ch30_main_30727938")
        call say_tl("ch30_main_0b6fd53a")
        call say_tl("ch30_main_dbb605af")
        call say_tl("ch30_main_5205494e")
        call say_tl("ch30_main_39793f58")
        call say_tl("ch30_main_88ffcdf2")
        call say_tl("ch30_main_8c11a667")
        call say_tl("ch30_main_3e56c1ae")
        call say_tl("ch30_main_0452eddd")
        call say_tl("ch30_main_fdfe248c")
        call say_tl("ch30_main_ce7125dd")
        call say_tl("ch30_main_59d438d6")
        call say_tl("ch30_main_28a60277")
        call say_tl("ch30_main_821a9153")
        call say_tl("ch30_main_b3510994")
        call say_tl("ch30_main_209e0a20")
        call say_tl("ch30_main_59c62df7")
        call say_tl("ch30_main_dae0fd3a")
        call say_tl("ch30_main_4b2e4480")
        call say_tl("ch30_main_6d5f2e9e")
        call say_tl("ch30_main_772a2ed5")
        call say_tl("ch30_main_c3bd47dd")
        call say_tl("ch30_main_2ba7a619")
        call say_tl("ch30_main_c069f68d")
        call say_tl("ch30_main_6867bacc")
        call say_tl("ch30_main_9b68a2f3")
        call say_tl("ch30_main_eb451b79")
        call say_tl("ch30_main_e759adc3")
        call say_tl("ch30_main_fb0b2e18")
        call say_tl("ch30_main_c2d00255")
        call say_tl("ch30_main_4ae14343")
        call say_tl("ch30_main_cd7e772f")
        call say_tl("ch30_main_f1ede7eb")
        call say_tl("ch30_main_0bcf5df1")
        call say_tl("ch30_main_cecf179f")
        call say_tl("ch30_main_cd3d95ff")
        call say_tl("ch30_main_f4d55975")
        call say_tl("ch30_main_371663ab")
        call say_tl("ch30_main_c36ec944")
        call say_tl("ch30_main_68769496")
        call say_tl("ch30_main_d417986c")
        call say_tl("ch30_main_06d76443")
        call say_tl("ch30_main_308900bf")
        call say_tl("ch30_main_d88ad03b")
        call say_tl("ch30_main_16160462")
        call say_tl("ch30_main_dd2cc392")
        call say_tl("ch30_main_35544121")
        call say_tl("ch30_main_77daefb4")
        call say_tl("ch30_main_921fea36")
        call say_tl("ch30_main_c36905bf")
        call say_tl("ch30_main_a918a573")
        call say_tl("ch30_main_9053e514")
        call say_tl("ch30_main_46189dbf")
        call say_tl("ch30_main_47172d60")
        call say_tl("ch30_main_971ddb73")
        call say_tl("ch30_main_4e20350d")
        call say_tl("ch30_main_f800d7dd")
        call say_tl("ch30_main_8906f9e7")
        call say_tl("ch30_main_43a2edaa")
        call say_tl("ch30_main_ff8d73bf")
...
translate None label:
    label ch30_main2:
        ...
        menu:
            "Yes.":
                pass
        call say_tl("ch30_main2_e7425310")
        call say_tl("ch30_main2_83820a11")
        call say_tl("ch30_main2_5805b297")
        call say_tl("ch30_main2_30727938")
        call say_tl("ch30_main2_bd0ed5b1")
        call say_tl("ch30_main2_3a2d419e")
        call say_tl("ch30_main2_fdc1263a")
        call say_tl("ch30_main2_9c850044")
        call say_tl("ch30_main2_77ff510d")
        call say_tl("ch30_main2_2586bf4c")
        call say_tl("ch30_main2_f47f5599")
        call say_tl("ch30_main2_dcb00e51")
        call say_tl("ch30_main2_83a8b5bf")
        call say_tl("ch30_main2_007ddb7d")
        call say_tl("ch30_main2_912f77b1")
        if persistent.steam:
            call say_tl("ch30_main2_12b0ad72")
            call say_tl("ch30_main2_53c30c49")
        elif renpy.macintosh:
            call say_tl("ch30_main2_6303e025")
            call say_tl("ch30_main2_1d8a0cd9")
            call say_tl("ch30_main2_81cf3664")
        call say_tl("ch30_main2_f436eab8")
        call say_tl("ch30_main2_3631490f")
        call say_tl("ch30_main2_30727938_1")
        call say_tl("ch30_main2_e8dbe706")
        call say_tl("ch30_main2_8efa1c5c")
        call say_tl("ch30_main2_d8052c1a")
        call say_tl("ch30_main2_5ffca166")
        call say_tl("ch30_main2_909e7d68")
        call say_tl("ch30_main2_0ab81b26")
        call say_tl("ch30_main2_3f67b378")
        call poem
...
translate None label:
    label ch30_postpoem:
        ...
        show monika_bg_highlight
        play music m1
        call say_tl("ch30_postpoem_0f077782")
        call say_tl("ch30_postpoem_ab6e8ce4")
        call say_tl("ch30_postpoem_fae192da")
        call say_tl("ch30_postpoem_1c07fd6c")
        call say_tl("ch30_postpoem_c5925789")
        call say_tl("ch30_postpoem_7c9789ed")
        call say_tl("ch30_postpoem_58746078")
        call say_tl("ch30_postpoem_3e825380")
        call say_tl("ch30_postpoem_5f8f12f0")
        call say_tl("ch30_postpoem_81270b72")
        call say_tl("ch30_postpoem_f044bc59")
        call showpoem (poem_m4, music=False)
        call say_tl("ch30_postpoem_dcf1d83d")
        call say_tl("ch30_postpoem_a625ee7b")
        call say_tl("ch30_postpoem_8793fb5f")
        call say_tl("ch30_postpoem_035cb79b")
        call say_tl("ch30_postpoem_789b2f7c")
        call say_tl("ch30_postpoem_3a46389d")
        call say_tl("ch30_postpoem_3a3fe712")
        call say_tl("ch30_postpoem_5a7ba8c8")
        call say_tl("ch30_postpoem_20b2578d")
        call say_tl("ch30_postpoem_c1e3202d")
        call say_tl("ch30_postpoem_24f4f4b9")
        call say_tl("ch30_postpoem_0411d3ce")
        call say_tl("ch30_postpoem_ab5989fa")
        ...
        call say_tl("ch30_postpoem_5904aebb")
        call say_tl("ch30_postpoem_29779c7b")
        call say_tl("ch30_postpoem_2267be9f")
