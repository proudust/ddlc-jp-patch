...
translate None label:
    label ch23_end:
        ...
        with wipeleft_scene
        play music t3
        call say_tl("ch23_end_90de9c4d")
        call say_tl("ch23_end_0993759e")
        call say_tl("ch23_end_772ec4c7")
        if n_appeal >= 2:
            show natsuki 4q zorder 3 at f31
            call say_tl("ch23_end_bb2cf764")
        else:
            show natsuki 4q zorder 3 at f31
            call say_tl("ch23_end_a8557d5c")
            call say_tl("ch23_end_2035e967")
            call say_tl("ch23_end_42c8edbf")
        show natsuki zorder 2 at t31
        show yuri 4b zorder 3 at f33
        call say_tl("ch23_end_6559e79e")
        call say_tl("ch23_end_3d9092ae")
        show yuri zorder 2 at t33
        show monika zorder 3 at f32
        call say_tl("ch23_end_08590660")
        call say_tl("ch23_end_5a08f549")
        if n_appeal >= 2:
            call say_tl("ch23_end_dd665f4a")
            call say_tl("ch23_end_18c7cbb6")
            show monika zorder 2 at t32
            show natsuki zorder 3 at f31
            call say_tl("ch23_end_07a96f6a")
            show natsuki zorder 2 at t31
            show monika zorder 3 at f32
        else:
            call say_tl("ch23_end_770e4677")
            show monika zorder 2 at t32
            show natsuki zorder 3 at f31
            call say_tl("ch23_end_b0ad33ab")
            show natsuki 2a zorder 2 at t31
            show monika zorder 3 at f32
            call say_tl("ch23_end_b02e47f8")
            call say_tl("ch23_end_58304296")
        call say_tl("ch23_end_31d39fd0")
        call say_tl("ch23_end_bed9d866")
        call say_tl("ch23_end_222e42cb")
        show monika zorder 2 at t32
        show yuri zorder 3 at f33
        call say_tl("ch23_end_a17b13bf")
        call say_tl("ch23_end_c0d26207")
        show yuri zorder 2 at t33
        show monika zorder 3 at f32
        call say_tl("ch23_end_acf82de7")
        show monika zorder 2 at t32
        show yuri zorder 3 at f33
        call say_tl("ch23_end_78d0b4fa")
        call say_tl("ch23_end_364de31c")
        call say_tl("ch23_end_e9660d91")
        show yuri zorder 2 at t33
        show monika zorder 3 at f32
        call say_tl("ch23_end_19a8f971")
        call say_tl("ch23_end_2d145eae")
        call say_tl("ch23_end_2ef36761")
        show monika zorder 2 at t32
        show yuri zorder 3 at f33
        call say_tl("ch23_end_5f1028e8")
        call say_tl("ch23_end_69b689b0")
        show yuri zorder 2 at t33
        show monika zorder 3 at f32
        call say_tl("ch23_end_f12d9d00")
        show monika 2a zorder 2 at t32
        show natsuki zorder 3 at f31
        call say_tl("ch23_end_03042821")
        call say_tl("ch23_end_1cff0263")
        show natsuki zorder 2 at t31
        show monika zorder 3 at f32
        call say_tl("ch23_end_ec97ece1")
        show monika zorder 2 at t32
        show natsuki zorder 3 at f31
        call say_tl("ch23_end_1cadb8f9")
        call say_tl("ch23_end_8c2e73b8")
        show natsuki zorder 2 at t31
        show yuri zorder 3 at f33
        call say_tl("ch23_end_2d1ca9bc")
        call say_tl("ch23_end_2fcdee48")
        call say_tl("ch23_end_916ef5f0")
        show yuri zorder 2 at t33
        show natsuki zorder 3 at f31
        call say_tl("ch23_end_613a8351")
        show natsuki zorder 2 at t31
        show yuri zorder 3 at f33
        call say_tl("ch23_end_55f6cc17")
        call say_tl("ch23_end_43eb3793")
        show yuri zorder 2 at t33
        show natsuki zorder 3 at f31
        call say_tl("ch23_end_6c43f72e")
        call say_tl("ch23_end_337d9e3a")
        call say_tl("ch23_end_65c4d2ca")
        show natsuki zorder 2 at t31
        show monika zorder 3 at f32
        call say_tl("ch23_end_302246ea")
        call say_tl("ch23_end_c61da5ee")
        show monika zorder 2 at t32
        show natsuki zorder 3 at f31
        call say_tl("ch23_end_83974bd9")
        show natsuki zorder 2 at t31
        show monika zorder 3 at f32
        call say_tl("ch23_end_53e2984b")
        show monika zorder 2 at t32
        show yuri zorder 3 at f33
        call say_tl("ch23_end_5c462463")
        call say_tl("ch23_end_6cda4708")
        show yuri zorder 2 at t33
        show monika zorder 3 at f32
        call say_tl("ch23_end_c26d6924")
        call say_tl("ch23_end_34212887")
        show monika 1h zorder 2 at t32
        show natsuki zorder 3 at f31
        call say_tl("ch23_end_cc188cde")
        call say_tl("ch23_end_73b7482c")
        call say_tl("ch23_end_c9ec79af")
        show natsuki zorder 2 at t31
        show yuri zorder 3 at f33
        call say_tl("ch23_end_f1c1e0f4")
        show yuri zorder 2 at t33
        show natsuki zorder 3 at f31
        call say_tl("ch23_end_01f5b930")
        show natsuki zorder 2 at t31
        show monika zorder 3 at f32
        call say_tl("ch23_end_9976091a")
        call say_tl("ch23_end_bf2e6adc")
        show monika zorder 2 at t32
        python:
        ...
        call say_tl("ch23_end_9128784d")
        call say_tl("ch23_end_8c48ee6a")
        call say_tl("ch23_end_bb9bc753")
        call say_tl("ch23_end_67ca5074")
        show natsuki 1e zorder 3 at f31
        call say_tl("ch23_end_308070ea")
        call say_tl("ch23_end_77a6e6ae")
        show natsuki zorder 2 at t31
        show monika zorder 3 at f32
        call say_tl("ch23_end_08045a7c")
        call say_tl("ch23_end_a5a60aa3")
        show monika zorder 2 at t32
        show yuri 3r zorder 3 at f33
        call say_tl("ch23_end_c092a8ae")
        call say_tl("ch23_end_c3761d87")
        call say_tl("ch23_end_de7db816")
        show yuri zorder 2 at t33
        show monika zorder 3 at f32
        call say_tl("ch23_end_eb1ce579")
        call say_tl("ch23_end_882dcfe0")
        call say_tl("ch23_end_0f02c58e")
        stop music
        show monika zorder 2 at t32
        show yuri zorder 3 at f33
        call say_tl("ch23_end_ab03ad61")
        call say_tl("ch23_end_f0b3f2ff")
        call say_tl("ch23_end_18e83623")
        call say_tl("ch23_end_545f48d9")
        call say_tl("ch23_end_97fd4494")
        call say_tl("ch23_end_c6ade6c2")
        call say_tl("ch23_end_d50febc8")
        call say_tl("ch23_end_c3d21cd4")
        call say_tl("ch23_end_07331406")
        show yuri zorder 2 at t33
        show natsuki zorder 3 at f31
        call say_tl("ch23_end_930a0609")
        show natsuki zorder 2 at t31
        show monika zorder 3 at f32
        call say_tl("ch23_end_f56c7ce9")
        call say_tl("ch23_end_21e3a942")
        show monika zorder 2 at t32
        show yuri zorder 3 at f33
        call say_tl("ch23_end_7dedcc9b")
        call say_tl("ch23_end_3556f8ae")
        call say_tl("ch23_end_24e5486c")
        hide natsuki
        hide monika
        hide yuri
        with wipeleft
        call say_tl("ch23_end_745f0277")
        show monika 5a zorder 2 at t11
        call say_tl("ch23_end_a6fb49ba")
        call say_tl("ch23_end_289f2833")
        show monika zorder 1 at thide
        hide monika
        call say_tl("ch23_end_1bd53e19")
        python:
            try: renpy.file(config.basedir + "/have a nice weekend!")
            except: open(config.basedir + "/have a nice weekend!", "w").write(file_message_have_a_nice_weekend)
        ...
        call say_tl("ch23_end_48472cac")
        call say_tl("ch23_end_6f7becde")
        call say_tl("ch23_end_0ea00341")
        call say_tl("ch23_end_e0675fad")
        call say_tl("ch23_end_1c42a8cc")
        call say_tl("ch23_end_8b46655e")
        call say_tl("ch23_end_0c29b271")
        call say_tl("ch23_end_def926ca")
        call say_tl("ch23_end_fd7f98ce")
        call say_tl("ch23_end_90d54275")
        call say_tl("ch23_end_84558ab0")
        call say_tl("ch23_end_5b7c6a6a")
        call say_tl("ch23_end_7c8fd563")
        call say_tl("ch23_end_112ff60f")
        call say_tl("ch23_end_1362d6af")
        call say_tl("ch23_end_5e6ebd2a")
        call say_tl("ch23_end_14185dfe")
        call say_tl("ch23_end_9de8a560")
        call say_tl("ch23_end_d81ffb78")
        call say_tl("ch23_end_e06606db")
        call say_tl("ch23_end_36ddf789")
        call say_tl("ch23_end_3bbfc16f")
        call say_tl("ch23_end_17c9d53a")
        call say_tl("ch23_end_b7ae0f1d")
        call say_tl("ch23_end_80a57d60")
        call say_tl("ch23_end_343025a1")
        call say_tl("ch23_end_715e5a8d")
        call say_tl("ch23_end_3927c53b")
        call say_tl("ch23_end_9d16ea33")
        call say_tl("ch23_end_fd055dd7")
        call say_tl("ch23_end_1e8884fa")
        call say_tl("ch23_end_e203cdfd")
        call say_tl("ch23_end_149971d3")
        call say_tl("ch23_end_b99df2bd")
        call say_tl("ch23_end_e11c83e6")
        call say_tl("ch23_end_c162d243")
        call say_tl("ch23_end_ce414874")
